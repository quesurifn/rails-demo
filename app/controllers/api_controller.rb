...
class ApiController < ApplicationController
  def index
    ...
    data = RestClient.get("api.openweathermap.org/data/2.5/forecast?q=Phoenix,us&units=imperial&appId=#{api_key}")
    ...
    list = list.map do |k, v|
      ...
      {date: k, max_temp: max_temp['main']['temp'], min_temp: min_temp['main']['temp'],
        average_humidity: average_humidity, description: description, wind: wind}
    end
